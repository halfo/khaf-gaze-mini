...
let t, n;
const r = new WeakMap(), o = new WeakMap(), s = new WeakMap();
let i = {
  get(e, t, n) {
...
function u(n) {
  return "function" == typeof n
    ? c(n)
    : (n instanceof IDBTransaction && function (e) {
      if (r.has(e)) return;
...
function B(e, t) {
  ...
  const n = t.replace(/FromIndex$/, ""), r = t !== n, o = I.includes(n);
  if (
    !(n in (r ? IDBIndex : IDBObjectStore).prototype) || !o && !D.includes(n)
  ) return;
...
export { d as wrap, f as openDB, l as unwrap, p as deleteDB };
export default null;
